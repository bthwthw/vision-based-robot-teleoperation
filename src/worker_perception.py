...
class PerceptionWorker:
    ...
    def run(self):
        ...
        tcp_filter = Position3DFilter(min_cutoff=0.025, beta=20.0, cutoff_max=15.0, reject_max_jump_mps=2.18, slew_limit_mps=1.0)
        quat_filter = QuaternionFilter(min_cutoff=0.025, beta=10.0, cutoff_max=20.0, reject_max_omega=2.09, max_rejects=10, slew_limit_omega=2.0)
        gripper_filter = Scalar1DFilter(min_cutoff=0.5, beta=0.5, cutoff_max=10.0, reject_max_jump=350.0, slew_limit_mps=300)
